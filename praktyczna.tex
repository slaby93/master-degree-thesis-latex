...
Dla porównania, przedstawiona na rysunku \ref{fig:rysunek_8} ilustracja pokazuje cykl działania aplikacji SPA
...
Na rysunku \ref{fig:rysunek_14} przedstawiam listę akcji jakie aplikacja musi implementować:
...
Z kolei na rysunku \ref{fig:rysunek_25} zostało przedstawione, iż pomimo początkowych problemów z uzyskaniem połączenia, mechanizm zadziałał poprawnie i udało się nawiązać połączenie.
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=10cm]{rysunek_28.png}
